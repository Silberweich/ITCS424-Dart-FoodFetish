...
String fullDataToJson(FullData data) => json.encode(data.toJson());
...
class Recipe {
  ...
  factory Recipe.fromJson(Map<String, dynamic> json) {
    List<Nutrition> total = [];
    List<Nutrition> daily = [];
    json["totalNutrients"].forEach((x,y) {
      total.add(
        Nutrition(
          key: x,
          label: y["label"],
